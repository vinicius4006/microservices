...
func (u *User) GetByEmail(email string) (*User, error) {
	...
	query := `select id, email, first_name, last_name, password, user_active, created_at, updated_at from users email = $1`
...
func (u *User) Insert(user User) (int, error) {
	...
	stmt := `insert into users (email, first_name, last_name, password, user_active, created_at, values ($1, $2, $3, $4, $5, $6, $7	) returning id)`
